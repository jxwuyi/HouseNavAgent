...
CUDA_VISIBLE_DEVICES=5 python train.py --seed 0 --algo ddpg_joint --update-freq 10 --linear-reward --max-episode-len 50 \
    ...
    --save-dir ./_model_/multi_house/linear_reward/segjoint_10house_medium/ddpg_joint_100_exp_high_hist_3 \
    --log-dir ./log/multi_house/linear_reward/segjoint_10house_medium/ddpg_joint_100_exp_high_hist_3 \
