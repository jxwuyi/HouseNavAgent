...
CUDA_VISIBLE_DEVICES=1,2 python3 zmq_train.py --seed 0 --env-set small \
    --n-house 20 --n-proc 80 --batch-size 64 --t-max 25 --max-episode-len 100 \
    ...
    --save-dir ./_model_/icml/small/hard_seg/bc64_gate_tmax25 \
    --log-dir ./log/icml/small/hard_seg/bc64_gate_tmax25
