...
CUDA_VISIBLE_DEVICES=0,1,2 python3 zmq_train.py --seed 0 --env-set small \
    ...
    --auxiliary-task --aux-loss-coef 1.0 \
    ...
    --save-dir ./_model_/zmq_a3c/aux_task_20house/hard_color/delta_bn_bc64_tmax5_gate_auxc1\
    --log-dir ./log/zmq_a3c/aux_task_20house/hard_color/delta_bn_bc64_tmax5_gate_auxc1
