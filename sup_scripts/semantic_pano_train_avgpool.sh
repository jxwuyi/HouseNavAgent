#!/bin/bash
#target="kitchen"
all_targets="kitchen outdoor living_room dining_room bedroom bathroom garage office"
data_dir="large"
test_data_dir="small"
train_part=10
test_part=1
...
CUDA_VISIBLE_DEVICES=2 python3 semantic_train.py --seed 0 --panoramic \
    ...
    --batch-size 256 --grad-batch 1 --epochs 40 \
    --lrate 0.0005 --weight-decay 0.00001 --grad-clip 5.0 --dropout-rate 0.0 \
