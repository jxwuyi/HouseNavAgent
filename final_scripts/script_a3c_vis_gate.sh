...
CUDA_VISIBLE_DEVICES=1,2,3 python3 zmq_train.py --seed 0 --env-set small \
    ...
    --segmentation-input none --depth-input --resolution normal \
    ...
    --save-dir ./_model_/new/zmq_a3c/small/hard/bn_bc64_gate_tmax20 \
    --log-dir ./log/new/zmq_a3c/small/hard/bn_bc64_gate_tmax20 
