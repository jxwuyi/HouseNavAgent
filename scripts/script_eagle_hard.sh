...
CUDA_VISIBLE_DEVICES=3 python train.py --algo ddpg_eagle --seed 0 --house 0 --update-freq 10 \
    --max-episode-len 100 --linear-reward --replay-buffer-size 1500000 \
    --lrate 0.0001 --critic-lrate 0.001 --gamma 0.95 \
    --save-dir ./_model_/eagle_view/hard/gating_cnn/exp_low_distsample_eplen50_freq10 \
    --log-dir ./log/eagle_view/hard/gating_cnn/exp_low_distsample_eplen50_freq10 \
    --batch-size 256 --hardness 0.95 \
    --critic-weight-decay 0.00001 --critic-penalty 0.0001 --batch-norm --no-debug \
    --noise-scheduler medium #--dist-sampling
