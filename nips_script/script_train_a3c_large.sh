...
CUDA_VISIBLE_DEVICES=3,4,5,6,7 python3 zmq_train.py --job-name large \
    ...
    --n-house 200 --n-proc 200 --batch-size 32 --t-max 60 --grad-batch 2  \
    --max-episode-len 60 \
    ...
    --save-dir ./_model_/nips/large/birth15_seg/a3c_bc128_gate_tmax60_new \
    --log-dir ./log/nips/large/birth15_seg/a3c_bc128_gate_tmax60_new
