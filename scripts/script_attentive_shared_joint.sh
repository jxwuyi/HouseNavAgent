...
CUDA_VISIBLE_DEVICES=2 python3 train.py --algo ddpg_joint --model attentive_cnn --seed 0 --update-freq 10 \
    --house 0 \
    --max-episode-len 50 --linear-reward --replay-buffer-size 100000 \
    --lrate 0.0001 --gamma 0.95 \
    --save-dir ./_model_/att_shared_joint/house0/linear_reward/medium/bc_eplen50_freq10 \
    --log-dir ./log/att_shared_joint/house0/linear_reward/medium/bc_eplen50_freq10 \
    ...
    --att-resolution low --att-skip-depth --att-shared-cnn
