...
CUDA_VISIBLE_DEVICES=0,1,2 python3 zmq_train.py --seed 0 --env-set small \
    --n-house 20 --n-proc 120 --batch-size 64 --t-max 30 --max-episode-len 100 \
    ...
    --save-dir ./_model_/new/zmq_a3c/small/hard_color/bn_bc64_gate_new \
    --log-dir ./log/new/zmq_a3c/small/hard_color/bn_bc64_gate_new
