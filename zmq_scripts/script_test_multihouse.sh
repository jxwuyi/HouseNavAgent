...
logfile='./log/eval/zmq_a3c/full_test/hard_color_see/a3c_fixtar_10house_delta_bn_bc64_tmax5'

CUDA_VISIBLE_DEVICES=2 python3 eval.py --env-set test --house -50 --seed 0 --hardness 0.95 \
