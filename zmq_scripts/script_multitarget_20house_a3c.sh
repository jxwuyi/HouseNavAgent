...
CUDA_VISIBLE_DEVICES=5,6,7 python3 zmq_train.py --seed 0 \
    --n-house 20 --n-proc 120 --batch-size 64 --t-max 5 --max-episode-len 50 \
    ...
    --save-dir ./_model_/zmq_a3c/20house_multitarget/medium/delta_bn_bc64_tmax5_gate \
    --log-dir ./log/zmq_a3c/20house_multitarget/medium/delta_bn_bc64_tmax5_gate
