...
CUDA_VISIBLE_DEVICES=1 python3 train.py --algo ddpg_joint --model attentive_cnn --seed 0 --update-freq 10 \
    ...
    --save-dir ./_model_/att_shared_joint/multi_house/linear_reward/medium/house10_eplen50_freq10 \
    --log-dir ./log/att_shared_joint/multi_house/linear_reward/medium/house10_eplen50_freq10 \
