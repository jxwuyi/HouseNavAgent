...
CUDA_VISIBLE_DEVICES=4 python train.py --seed 0 --algo dqn --update-freq 5 --max-episode-len 60 \
    ...
    --save-dir ./_model_/multi_target/20house_medium/delta_segcolor_dqn_gate_eplen60_exp_exp \
    --log-dir ./log/multi_target/20house_medium/delta_segcolor_dqn_gate_eplen60_exp_exp \
