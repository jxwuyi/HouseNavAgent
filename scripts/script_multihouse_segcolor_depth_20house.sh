...
CUDA_VISIBLE_DEVICES=3 python3 train.py --env-set small --seed 0 --algo ddpg_joint --update-freq 5 --max-episode-len 100 \
    ...
    --save-dir ./_model_/multi_house/delta_reward/segcolor_depth_20house_medium/ddpg_joint_100_exp_high_hist_3 \
    --log-dir ./log/multi_house/delta_reward/segcolor_depth_20house_medium/ddpg_joint_100_exp_high_hist_3 \
