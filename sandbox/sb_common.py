import sys, json
conf = json.load(open('sandbox_conf.json', 'r'))
sys.path.insert(0, conf['main_path'])
sys.path.insert(0, conf['sandbox_path'])
...
from sandbox.roomnav import n_discrete_actions
from sandbox.house import Environment as HouseEnv
from sandbox.core import MultiHouseEnv
from sandbox.house import House
from sandbox.house import ALLOWED_TARGET_ROOM_TYPES, ALLOWED_PREDICTION_ROOM_TYPES, ALLOWED_OBJECT_TARGET_TYPES
from sandbox.roomnav import RoomNavTask
from sandbox import objrender
