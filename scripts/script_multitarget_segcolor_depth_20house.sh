...
CUDA_VISIBLE_DEVICES=5 python3 train.py --seed 0 --algo ddpg_joint --update-freq 5 --max-episode-len 100 \
    ...
    --save-dir ./_model_/multi_target/delta_reward/segcolor_depth_20house_medium/ddpg_joint_gate_100_exp_high_hist_3 \
    --log-dir ./log/multi_target/delta_reward/segcolor_depth_20house_medium/ddpg_joint_gate_100_exp_high_hist_3 \
